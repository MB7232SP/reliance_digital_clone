...
async function roll1(){
    let data=await getData(`https://reliance-json-server.onrender.com/roll1`);
    // console.log(data);
    // let i=0;
...
async function roll2(){
    let data=await getData(`https://reliance-json-server.onrender.com/roll2`);
    // console.log(data);
    let i=0;
...
async function hp3(){
    let data=await getData(`https://reliance-json-server.onrender.com/laptop`);
    let key="laptop";
    console.log(data);
...
async function hp4(){
    let data=await getData(`https://reliance-json-server.onrender.com/appliances`);
    let key="appliances";
    console.log(data);
...
async function hp10(){
    let data=await getData(`https://reliance-json-server.onrender.com/watches`);
    let key="watches";
    console.log(data);
...
async function hp12(){
    let data=await getData(`https://reliance-json-server.onrender.com/tvForHomePage`);
...
async function hp11(){
    let data=await getData(`https://reliance-json-server.onrender.com/soundbar`);
    let key="soundbar";
    console.log(data);
