...
let teldData = async () => {
  try {
    let data = await telgetData('https://reliance-json-server.onrender.com/television?_page1&_limit=20');
    displayTeldata(data);
...
let teldData2 = async () => {
  try {
    let data = await telgetData('https://reliance-json-server.onrender.com/television?_page=2&limit_20');
    displayTeldata(data);
...
async function filter_data(minprice=0,maxprice=0) {
  let url = 'https://reliance-json-server.onrender.com/television?_page=1&_limit=20';
...
//https://reliance-json-server.onrender.com/television?_sort=dealprice&_order=asc
